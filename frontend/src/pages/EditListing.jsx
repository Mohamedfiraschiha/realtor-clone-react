      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-slate-900">Edit Listing</h1>
              <p className="text-gray-600 mt-1">Update your property details and information</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          <form onSubmit={onSubmit}>
            ...
            {/* Property Name */}
            <div className="mb-8">
              <label htmlFor="name" className="block text-sm font-semibold text-gray-900 mb-2">Property Name</label>
              <input 
                type="text" 
                id="name" 
                value={formData.name || ''} 
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              <div>
                <label htmlFor="bedrooms" className="block text-sm font-semibold text-gray-900 mb-2">Bedrooms</label>
                <input 
                  type="number" 
                  id="bedrooms" 
              ...
              <div>
                <label htmlFor="bathrooms" className="block text-sm font-semibold text-gray-900 mb-2">Bathrooms</label>
                <input 
                  type="number" 
                  id="bathrooms" 
            ...
            {/* Parking */}
            <div className="mb-8">
              <label className="block text-sm font-semibold text-gray-900 mb-3">Parking Spot</label>
              <div className="grid grid-cols-2 gap-4">
                <button 
                  type="button" 
                  id="parking" 
            ...
            {/* Furnished */}
            <div className="mb-8">
              <label className="block text-sm font-semibold text-gray-900 mb-3">Furnished</label>
              <div className="grid grid-cols-2 gap-4">
                <button 
                  type="button" 
                  id="furnished" 
            ...
            {/* Offer */}
            <div className="mb-8">
              <label className="block text-sm font-semibold text-gray-900 mb-3">Special Offer</label>
              <div className="grid grid-cols-2 gap-4">
                <button 
                  type="button" 
                  id="offer" 
            ...
            {/* Regular Price */}
            <div className="mb-8">
              <label htmlFor="regularPrice" className="block text-sm font-semibold text-gray-900 mb-2">
                Regular Price {formData.type === "rent" && <span className="text-gray-500 font-normal">($ / Month)</span>}
              </label>
            ...
            {formData.offer && (
              <div className="mb-8">
                <label htmlFor="discountedPrice" className="block text-sm font-semibold text-gray-900 mb-2">Discounted Price</label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 font-medium">$</span>
                  <input 
                    type="number" 
            ...
            <div className="mb-8">
              <label htmlFor="images" className="block text-sm font-semibold text-gray-900 mb-2">
                ...
                Property Images <span className="text-gray-500 font-normal">(max 6)</span>
              </label>
              ...
              />
              <p className="mt-2 text-sm text-gray-500">Upload up to 6 images (JPG, PNG, JPEG)</p>
            </div>
